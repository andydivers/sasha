...
**$25k — 3 месяца — 7% equity**

- $5k — GPU для тонкой настройки модели (функции агентов)
- $10k — Salaries (2 инженера, 2 месяца)
- $5k — AWS Compute (агентская инфраструктура)
- $5k — Юридическое + маркетинг

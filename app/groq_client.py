...
def build_system_prompt(lang: str) -> str:
    ...
    base += "\n- For reminders, call set_reminder. NEVER call add_expense/add_income/add_todo when the user asks to be reminded (напомни/напоминание/remind me/напомни что) — always set_reminder with a correct 'when' like 'завтра 9 утра', 'через 2 часа', '31 августа'."
    base += "\n- IMPORTANT: remember that 'напомни' means REMIND, not expense! Pass the WHOLE reminder text as 'message' and time as 'when'."

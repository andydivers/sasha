...
CURRENCY_SYMBOLS = {
    ...
    "₩": "KRW", "krw": "KRW",
    "AED": "AED", "د.إ": "AED", "дирхам": "AED", "درهم": "AED",
    "CNY": "CNY", "юань": "CNY", "yuan": "CNY", "元": "CNY", "人民币": "CNY",
    "INR": "INR", "₹": "INR", "рупи": "INR", "रुपये": "INR", "रुपया": "INR",
    "VND": "VND", "₫": "VND", "донг": "VND", "đồng": "VND",
    "JPY": "JPY", "円": "JPY", "yen": "JPY", "иена": "JPY",
    "EUR": "EUR", "يورو": "EUR",
    "USD": "USD", "دولار": "USD", "dólares": "USD", "dólar": "USD", "ドル": "USD",
    "TRY": "TRY", "лир": "TRY", "lira": "TRY", "ليرة": "TRY",
    "THB": "THB", "บาท": "THB", "泰铢": "THB",
    "SGD": "SGD",
    "MYR": "MYR", "рингит": "MYR",
    "PHP": "PHP", "песо": "PHP",
